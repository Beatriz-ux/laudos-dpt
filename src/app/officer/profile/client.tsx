...
interface OfficerProfileClientProps {
  user: User;
}

export function OfficerProfileClient({ user }: OfficerProfileClientProps) {
        ...
        <div className="p-6 border-b">
          <div className="flex items-start gap-6">
            <div className="w-24 h-24 bg-secondary rounded-full flex items-center justify-center">
              <UserIcon className="h-12 w-12 text-secondary-foreground" />
            </div>
            <div className="flex-1">
              ...
              <p className="text-muted-foreground">
                Responsável pela execução e análise de laudos
              </p>
            </div>
          </div>
        </div>
